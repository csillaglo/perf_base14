...
export function OrgChart({ users, onManagerChange, onEditClick, onDeleteClick }: OrgChartProps) {
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="font-medium text-gray-900 truncate">
                  {user.full_name || t('admin.users.table.unnamed')}
                </div>
  ...
  if (filteredUsers.length === 0) {
    return <div className="text-center py-8">{t('admin.users.noTeamMembers')}</div>;
  }
  ...
  return (
    <div className="space-y-8">
          ...
          {unassignedNodes.length > 0 && (
            <div className="mt-12 pt-12 border-t border-gray-200">
              <h3 className="text-lg font-medium text-gray-900 mb-6">
                {t('admin.users.unassignedUsers')} ({unassignedNodes.length})
              </h3>
                  ...
                  >
                    <div className={`bg-white p-4 rounded-lg shadow-md border border-gray-200 ${
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="font-medium text-gray-900 truncate">
                            {node.user.full_name || t('admin.users.table.unnamed')}
                          </div>
      ...
      <div className="text-sm text-gray-500 text-center">
        {t('admin.users.dragAndDropInstructions')}
      </div>
    </div>
  );
}
